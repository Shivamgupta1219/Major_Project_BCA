...
function Testimonials() {
  ...
  const CreateCard = ({ card }) => (
    <div className="p-3 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
  ...
  return (
    <div id="features" className=" flex flex-col items-center scroll-mt-12">
      ...
      <Title
        ...
        description="Hear what our users say about us. we are always lokkings for ways to improve . If you have a positive experience with us ,leave a review "
      />
