...
// Resume 3
 {
  personal_info: {
    ...
    email: "sgshivamgupta206@gmail.com",
    phone: "+91 6397863950",
    location: "Pandav Nagar, Saket, Meerut, India",
    linkedin: "", // add if you want
    website: "",  // add portfolio link if you want
  },

  professional_summary:
    "Full Stack Developer with hands-on experience in building AI-powered and MERN stack applications. Skilled in developing scalable web solutions, integrating AI models, and creating user-focused interfaces. Strong understanding of ATS optimization, RESTful APIs, and modern frontend frameworks.",
  ...
  experience: [
    {
      ...
      end_date: "",
      is_current: true,
      description: `• Enhanced an AI-powered Resume Builder using the MERN stack (frontend, backend, database).
• Integrated AI models to generate tailored resumes from job descriptions.
• Applied ATS score analysis to evaluate resumes and suggest optimizations.
• Enabled resume upload, AI-generated suggestions, and job-market alignment insights.
• Deployed the application with a scalable and secure architecture.`,
    },
  ],

  project: [
    {
      name: "AI Resume Builder | MERN Stack",
      description:
        "Developed an AI-powered resume builder that generates customized resumes based on job descriptions, provides ATS analysis, and offers optimization insights.",
    },
    {
      name: "Personal Portfolio | React.js",
      description:
        "Built and deployed a responsive personal portfolio using React.js and MERN stack. Integrated contact form with MongoDB, interactive map, Framer Motion animations, and optimized performance.",
    },
    {
      name: "To-Do List Application | MERN Stack",
      description:
        "Created a full CRUD To-Do application with React.js frontend, Node.js & Express backend, and MongoDB database. Added task tracking, edit functionality, and real-time status updates.",
    },
    {
      name: "School Management ERP | Angular",
      description:
        "Working on frontend development using Angular and SCSS. Built reusable UI components, responsive layouts, and contributed to attendance, calendar, and reporting modules.",
    },
  ],
  ...
  education: [
    ...
    {
      degree: "Intermediate",
      institution: "Saraswati Vidya Mandir Inter College, Kotdwara",
