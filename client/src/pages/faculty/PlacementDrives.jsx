        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-600 mt-1">Create and manage placement drives for your college</p>
            </div>
            <Link
              to="/faculty/placement-drives/create"
          ...
          <div className="flex gap-4">
            ...
            <select
              ...
              className="px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600"
            >
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                      <Link
                        to={`/faculty/placement-drives/${drive._id}`}
                      ...
                      <Link
                        to={`/faculty/placement-drives/edit/${drive._id}`}
                        className="p-2 hover:bg-slate-100 rounded-lg text-slate-600 hover:text-slate-900 transition-colors"
                        title="Edit"
                      >
...
export default FacultyPlacementDrives;
