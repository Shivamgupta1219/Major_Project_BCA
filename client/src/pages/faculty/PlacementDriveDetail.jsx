...
import { ArrowLeft, CheckCircle2, Users, Calendar, DollarSign, MapPin, Edit2 } from "lucide-react";
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-8 mb-6">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => navigate(`/faculty/placement-drives/edit/${driveId}`)}
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-8">
            ...
            {drive.registeredStudents && drive.registeredStudents.length > 0 && (
              <button
                ...
                disabled={updating}
                className="w-full mt-4 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium disabled:opacity-50"
              >
